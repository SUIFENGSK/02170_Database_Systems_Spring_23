...
-- 2.4
SELECT * FROM Department WHERE Budget>=70000 AND Building='Taylor';
-- 2.5
SELECT instID, instName FROM Instructor, Department WHERE Instructor.DeptName = Department.DeptName AND Budget>=100000;
SELECT instID, instName FROM Instructor NATURAL JOIN Department WHERE Budget>=100000;
-- 2.6
...
-- 2.8
INSERT Instructor SELECT StudID, StudName, DeptName, 10000 FROM Student WHERE TotCredits > 100;
-- 2.10
...
-- 2.17
SELECT InstName, Salary, DeptName FROM Instructor;
-- 2.18
SELECT StudName FROM Student WHERE TotCredits>100;
-- 2.19
SELECT StudName FROM Student WHERE DeptName='Comp. Sci.' AND TotCredits>100;
-- 2.20
SELECT Room FROM Classroom WHERE (Capacity<50 AND Capacity>25) OR Building='Painter';
-- 2.21
SELECT DeptName FROM Department WHERE Building<>'Taylor';
-- 2.22
SELECT CourseID, StudyYear, Grade FROM Takes, Student WHERE Takes.StudID=Student.StudID AND StudName='Shankar';
SELECT CourseID, StudyYear, Grade FROM Takes NATURAL JOIN Student WHERE StudName='Shankar';
-- 2.23
INSERT Course VALUES ('CS-102', 'Weekly Seminar', 'Comp. Sci.',0), ('CS-103', 'Monthly Seminar', 'Comp. Sci.',0);
SELECT * FROM Course;
-- 2.24
INSERT Section VALUES ('CS-102', '1', 'Fall', 2009, NULL, NULL, NULL), ('CS-103', '1', 'Fall', 2009, NULL, NULL, NULL);
SELECT * FROM Section;
-- 2.25
INSERT Takes SELECT StudID, CourseID, SectionID, Semester, StudyYear, NULL FROM Student, Section WHERE DeptName='Comp. Sci.' AND CourseID='CS-102';
SELECT * FROM Takes;
-- 2.26
